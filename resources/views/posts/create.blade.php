            ...
            <div class=" w-1/2 mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
                <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <input name="title" type="text" id="base-input" value="{{ old('title') }}" class="@error('title')
                            border-red-500
                    ...
                    <div class="mb-6">
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="thumbnail" name="thumbnail" value="{{ old('thumbnail') }}" type="file">
                        @error('thumbnail')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
